...
model=load_model('C:\python\Stock Predictions Model.keras')

st.header= ('Stock Price Prediction App')

stock=st.text_input('Enter the stock ticker symbol','GOOG')
start='2012-01-01'
end='2022-12-31'
...
data_test=pd.concat([data_test,pas_100_days],ignore_index=True)
